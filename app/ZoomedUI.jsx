...
AI-Driven Marking & Feedback: I developed the core system allowing students to upload their exam papers for AI-powered grading and actionable feedback on their mistakes, with features allowing students to correct marking.

Intelligent, Personalized Revision: I built an algorithm that generates custom study plans based on user-specific parameters, such as their weakest topics, past scores, schedule, and preferred learning techniques (e.g., Pomodoro, Spaced Repetition).
...
Security: The application and user data are protected with API rate limiting against brute-force attacks, strict CORS policies, and comprehensive input sanitization to prevent common vulnerabilities like XSS. I drew on my experience at News UK to ensure best practices were followed.

This project demonstrates my ability to deliver a full-stack product that is technically robust, secure, commercially viable, and of a standard that clients are willing to pay for.`, tech: 'React Native, PostgreSQL, Railway, FastAPI' },
      { id: 'proj1', title: 'Stochastic Pair Trading Bot', link: 'https://github.com/tommatson/jekyll-hyde-ai', description: "This project implements a stochastic AI-driven pair trading bot focused on the stocks AMAT (Applied Materials) and NXPI (NXP Semiconductors), selected based on cointegration analysis. The bot leverages two AI layers: a Gradient Boosting model and a Reinforcement Learning (RL) agent to identify and exploit arbitrage opportunities between the two securities, complete with a backtesting and live performance framework. The bot achieved a positive ROI and was a valuable learning experience.", tech: 'Python, XGBoost, RL, NumPy, Pandas' },
      { id: 'proj2', title: 'Manual Image Recognition Tools', link: 'https://github.com/tommatson/CBIR-tools', description: 'A pure-C image processing library focused on manual/hybrid content-based image recognition. Built entirely from scratch with no external dependencies, it implements core computer vision algorithms with full control and transparency.', tech: 'C, Computer Vision' },
      { id: 'proj3', title: 'Scotland Yard AI', description: "For this project, I programmed an AI for the board game 'Scotland Yard' based on Monte Carlo tree search methods. On top of this, I implemented a custom algorithm to make the AI non-Markovian for experimental purposes.", tech: 'Java, OOP, AI' },
      { id: 'proj4', title: 'Multilayer Perceptron', link: 'https://github.com/tommatson/multilayer-perceptron', description: 'A simple machine learning project that uses a Multi-Layer Perceptron (MLP) to recognize handwritten digits (0–9). It includes a Python-based drawing interface and C++ for the core machine learning logic. The C++ logic was programmed entirely from scratch (training and prediction framework) and trained on the MNIST dataset.', tech: 'C++, Python, AI' },
      { id: 'proj5', title: 'Raycasting Engine', link: 'https://github.com/tommatson/raycasting-engine',description: 'A CPU-bound raycasting engine, inspired by Wolfenstein 3D, written entirely from scratch using C++ and SDL2.', tech: 'C++' },
      { id: 'proj6', title: 'Hardware-Level DES Block Cipher', description: `Achieved a grade of 93% by engineering a complete, hardware-level implementation of the 16-round Data Encryption Standard (DES) algorithm in Verilog at the Register-Transfer Level (RTL).
Demonstrated mastery of low-level computer architecture, digital logic design, and fundamental cryptographic principles, proving ability to excel in complex systems engineering challenges.`, tech: 'Verilog, Digital Logic' },
      { id: 'proj7', title: 'Scotland Yard AI Agent', description: `Designed and implemented an intelligent agent in Java to play the board game Scotland Yard, utilising Monte Carlo Tree Search (MCTS) for optimal move decision-making.
Engineered a custom non-Markovian algorithm to enhance the AI's predictive capabilities by allowing it to reason about the opponent's historical patterns and potential future strategies.
Achieved a First-Class mark of 76% for the project, demonstrating strong skills in Object-Oriented design, complex algorithm implementation, and applying AI to strategic problems.`, tech: 'Java, AI' },
              
    ],
    experience: [
        { id: 'exp1', title: 'Work Experience at News UK', company: 'Product Security Department', period: 'Jun 2025', description: 'A week of work experience in the product security department of News UK. Here, I was presented with the chance to fully see how product security is implemented in a real-world setting. I was tasked with investigating the real-world implications of using AI-generated code in production-ready environments and wrote a report on various models and their ability to introduce vulnerabilities in code.' },
        { id: 'exp3', title: 'Work Experience at Kaluza', company: 'Software Development', period: 'Jun 2023', description: "A week's worth of work experience at Kaluza. Here I conversed with many employees and team leads within their ML and software engineering departments, learning many things about the lifecycle of software development. Throughout this experience, I was tasked by the lead engineer to build a custom data pipeline, I implemented this in python, saving hours of time for the team. From this I learned valuable practices from the design reviews I received throughout and my approach was praised for its speed and quality." },
    ...
    education: [
        ...
        { id: 'edu2', title: 'College of Richard Collyer', company: 'A-Levels', period: 'Graduated 2024', description: 'Successfully completed A-Level studies, providing a strong foundation for university. I achieved an A*, A, A, A in Mathematics, Further Mathematics, Computer Science, and Physics. I participated in several clubs, including Robotics, BEBRAS, Cybersec, table tennis and scale modeling.' },
        { id: 'edu3', title: 'Steyning', company: 'GCSE', period: 'Graduated 2022', description: 'Successfully completed GCSE studies, providing a strong foundation for A-Levels. I achieved an excellent grade average of 8.5, while winning awards such as the best Computer Science student, and best Physics student.' }
    ],
    trash: [
        { id: 'pong1', title: 'Pong' }
    ],
                             ...
                             <div key={item.id} className={styles.itemView} onClick={item.id === 'pong1' ? () => handleOpenFile(item) : null}>
                                {item.id === 'pong1' ? (
                                    ...
                                    <>
                                        ...
                                        {item.link && (<a href={item.link} target="_blank" rel="noopener noreferrer" className={styles.link}>View Project</a>)}
                                    </>
                                )}
                             </div>
                          ))}
